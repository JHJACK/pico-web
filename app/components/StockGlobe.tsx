...
const POINTS = [
  // 🇰🇷 Korea — 허브
  { lat: 37.5665, lng: 126.978,  label: "서울",      size: 0.58, color: "#FACA3E" },
  // 🇺🇸 USA
  { lat: 37.3688, lng: -122.036, label: "NVIDIA",    size: 0.42, color: "#F5C030" },
  { lat: 37.3317, lng: -122.031, label: "Apple",     size: 0.42, color: "#F5C030" },
  { lat: 30.2281, lng: -97.749,  label: "Tesla",     size: 0.36, color: "#F5C030" },
  { lat: 47.6423, lng: -122.139, label: "Microsoft", size: 0.38, color: "#F5C030" },
  { lat: 47.6204, lng: -122.349, label: "Amazon",    size: 0.36, color: "#F5C030" },
  { lat: 37.4847, lng: -122.148, label: "Meta",      size: 0.36, color: "#F5C030" },
  { lat: 40.7128, lng: -74.006,  label: "뉴욕",      size: 0.44, color: "#F5C030" },
  { lat: 41.2565, lng: -95.934,  label: "Berkshire", size: 0.28, color: "#E8B828" },
  // 🇯🇵 Japan
  { lat: 35.6762, lng: 139.650,  label: "도쿄",      size: 0.42, color: "#E8C860" },
  { lat: 35.0828, lng: 137.156,  label: "Toyota",    size: 0.30, color: "#E8C860" },
  // 🇹🇼 Taiwan
  { lat: 24.7794, lng: 120.996,  label: "TSMC",      size: 0.40, color: "#E8C060" },
  // 🇨🇳 China
  { lat: 30.2741, lng: 120.155,  label: "Alibaba",   size: 0.33, color: "#D4B050" },
  { lat: 22.5431, lng: 114.058,  label: "Tencent",   size: 0.33, color: "#D4B050" },
  { lat: 31.2304, lng: 121.474,  label: "상하이",    size: 0.36, color: "#D4B050" },
  // 🇸🇬 Singapore
  { lat: 1.3521,  lng: 103.820,  label: "싱가포르",  size: 0.32, color: "#E0C458" },
  // 🇮🇳 India
  { lat: 19.076,  lng: 72.878,   label: "뭄바이",    size: 0.28, color: "#CCA840" },
  // 🇬🇧 UK
  { lat: 51.5074, lng: -0.128,   label: "런던",      size: 0.40, color: "#C8A840" },
  // 🇫🇷 France
  { lat: 48.8566, lng: 2.352,    label: "파리",      size: 0.32, color: "#C8A840" },
  // 🇩🇪 Germany
  { lat: 52.520,  lng: 13.405,   label: "베를린",    size: 0.28, color: "#C8A840" },
  // 🇳🇱 Netherlands
  { lat: 51.4416, lng: 5.470,    label: "ASML",      size: 0.34, color: "#C8A840" },
  // 🇦🇺 Australia
  { lat: -33.869, lng: 151.209,  label: "시드니",    size: 0.28, color: "#BEA040" },
  // 🇧🇷 Brazil
  { lat: -23.550, lng: -46.633,  label: "상파울루",  size: 0.26, color: "#BEA040" },
  // 🇷🇺 Russia
  { lat: 55.751,  lng: 37.618,   label: "모스크바",  size: 0.24, color: "#B89830" },
  // 🇿🇦 South Africa
  { lat: -26.204, lng: 28.047,   label: "요하네스버그", size: 0.22, color: "#B09030" },
];
...
export default function StockGlobe({ height = 520 }: { height?: number }) {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      globe = new (Globe as any)({ animateIn: true })(el)
        .width(el.clientWidth)
        .height(height)
        .backgroundColor("rgba(0,0,0,0)")
        .globeImageUrl("//unpkg.com/three-globe/example/img/earth-night.jpg")
        .bumpImageUrl("//unpkg.com/three-globe/example/img/earth-topology.png")
        .atmosphereColor("rgba(250,202,62,0.55)")
        ...
        .arcStroke((d: any) =>
          d.ck === "g1" ? 0.55 : d.ck === "g2" ? 0.45 : d.ck === "g3" ? 0.38 : d.ck === "a1" ? 0.32 : 0.24
        );
  ...
  return <div ref={mountRef} style={{ width: "100%", height, cursor: "default" }} />;
}
