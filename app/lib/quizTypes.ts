...
export const INVESTOR_TYPES: Record<TypeKey, InvestorType> = {
  tiger: {
    ...
    compatible: "복리 설계사 코끼리",
  },
  wolf: {
    emoji: "🐺", modifier: "역발상 철학자", name: "늑대",
    ...
    compatible: "신중한 수호자 거북이",
  },
  eagle: {
    emoji: "🦅", modifier: "정확한 사냥꾼", name: "독수리",
    ...
    compatible: "철벽 방어 고슴도치",
  },
  fox: {
    emoji: "🦊", modifier: "정보 연금술사", name: "여우",
  ...
  butterfly: {
    ...
    compatible: "역발상 철학자 늑대",
  },
  hedgehog: {
    emoji: "🦔", modifier: "철벽 방어", name: "고슴도치",
    ...
    compatible: "정확한 사냥꾼 독수리",
  },
  elephant: {
    emoji: "🐘", modifier: "복리 설계사", name: "코끼리",
  ...
  turtle: {
    emoji: "🐢", modifier: "신중한 수호자", name: "거북이",
