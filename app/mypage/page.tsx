      ...
      >
        ...
        <div className="flex items-center gap-4 mb-[10px]"
          ...
          <div className="flex-1 min-w-0">
            <p className="nickname" style={{ fontSize: "clamp(22px, 6.5vw, 25px)", fontWeight: 500, color: "#e8e0d0", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{userRow.nickname}</p>
          </div>
        ...
        <div className="grid grid-cols-2 gap-[10px] mb-[10px]">
          ...
          >
            <div style={{ flex: 1, textAlign: "left" }}>
              ...
              <p className="point-value num" style={{ fontFamily: "var(--font-inter)", fontSize: "clamp(22px, 6vw, 25px)", fontWeight: 500, color: "#FACA3E", letterSpacing: "-0.02em" }}>
          ...
          >
            <div style={{ flex: 1 }}>
              <span className="card-body" style={{ fontSize: "clamp(14px, 4vw, 16px)", fontWeight: 500, color: "#e8e0d0" }}>오늘의 VS 대결 결과</span>
            </div>
        ...
        <div className="grid-2-col mb-8">
          ...
          <button onClick={() => router.push("/mypage/dna")} className="pico-btn"
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{ display: "flex", alignItems: "baseline", gap: 6, flexWrap: "wrap" }}>
                <span className="dna-modifier" style={{ fontSize: "clamp(14px, 4vw, 16px)", fontWeight: 500, color: "#e8e0d0" }}>
                  {dnaType ? dnaType.modifier : "투자 DNA"}
                </span>
                <span className="dna-animal" style={{ fontSize: "clamp(14px, 4vw, 16px)", fontWeight: 500, color: "#FACA3E" }}>
          ...
          <button onClick={() => router.push("/mypage/attendance")} className="pico-btn"
            ...
            <span className="card-body" style={{ fontSize: "clamp(14px, 4vw, 16px)", fontWeight: 500, color: "#e8e0d0", flex: 1, textAlign: "left" }}>출석체크 캘린더🔥</span>
            <div className="arrow-btn" style={{ width: 36, height: 36, background: "#1c1c1c", border: "0.5px solid rgba(255,255,255,0.07)", borderRadius: 12, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
              <span style={{ fontSize: 16, color: "#FACA3E" }}>›</span>
            </div>
          </button>
